...
public class PerlinNoiseAlgorithm {
     ...
     * integer input values. The reason for that is, the function
     * {@link de.pianomanu.asterania.world.gen.HomeWorldGeneration#main}
     * uses a Random Number Generator generating integer values between 0 and
     * 100, but the Perlin-Noise algorithm needs floating point inputs.
     *
